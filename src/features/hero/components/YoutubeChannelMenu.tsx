...
const ChannelItem = ({ channel, onNavigate }: ChannelItemProps) => (
  ...
  >
    ...
    />
    <span
      className="font-black text-sm uppercase tracking-widest flex-1"
  ...
  return (
    <div ref={containerRef} className="relative w-full sm:w-auto">
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        className="group relative flex items-center justify-center gap-3 px-10 py-5 rounded-full font-bold text-base tracking-wide uppercase overflow-hidden w-full sm:w-auto bg-gradient-to-r from-skorpion-red to-[#ff3b3b] text-skorpion-white shadow-[0_8px_20px_rgba(242,27,66,0.4)] hover:shadow-[0_12px_30px_rgba(242,27,66,0.6)]"
      >

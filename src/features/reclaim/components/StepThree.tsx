...
import { Gift, AlertCircle, ExternalLink, MessageCircle } from "lucide-react";
        ...
        {activeError && (
          ...
          >
            ...
            {error === "already_redeemed" && (
              <motion.a
                href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Olá! Preciso de ajuda para acessar o grupo do WhatsApp. Já resgatei meu código anteriormente.")}`}
                target="_blank"
                rel="noopener noreferrer"
                initial={{ opacity: 0, y: 4 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center justify-center gap-2.5 px-5 py-3 rounded-xl font-black text-xs uppercase tracking-wide text-white"
